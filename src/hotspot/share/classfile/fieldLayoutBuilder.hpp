...
class MultiFieldGroup : public ResourceObj {
 ...
 public:
  ...
  void add_field(FieldInfo* field, InlineKlass* vk, Array<MultiFieldInfo>* multifield_info);
...
class FieldGroup : public ResourceObj {
 ...
 public:
  ...
  void add_multifield(FieldInfo* field, Array<MultiFieldInfo>* multifield_info, InlineKlass* vk = NULL);
